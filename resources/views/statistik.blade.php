            ...
            <div class="col-xl-3">
                ...
                <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{ $siswa }}</div>
                        <div class="fw-bold text-gray-400">Jumlah Siswa</div>
                    </div>
                    <!--end::Body-->
                </a>
            ...
            <div class="col-xl-3">
                ...
                <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{ $univ }}</div>
                        <div class="fw-bold text-gray-100">Jumlah Universitas</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
            ...
            <div class="col-xl-3">
                ...
                <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{ $negara }}</div>
                        <div class="fw-bold text-white">Jumlah Negara</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
            ...
            <div class="col-xl-3">
                ...
                <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{ $kota }}</div>
                        <div class="fw-bold text-white">Jumlah Kota</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
